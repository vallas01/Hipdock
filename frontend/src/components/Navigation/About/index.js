...
const About = () => {
    return (
        <div className='about-outer-container'>
            ...
            <div className='aboutP'><p>&nbsp; &nbsp;This journey began with a father-son project and a small basic computer — a Raspberry Pi. &nbsp; As an avid sailor who loves DIY projects, I decided to build a chartplotter that would show the location and course of our sailboat and also the location and heading of other ships. &nbsp; Having our chart plotted on a TV monitor would let me see where the helmsman is taking us while I'm cooking in the galley. &nbsp; That information would have help avoid a recent near miss collision with a huge barge<em> but that is another story</em>.</p></div>
